...
object M2Classfier {
  ...
  def splitNonimal(instances: ArrayBuffer[LabeledFeature],
    iAttr: Int,
    numClass: Int,
    Wi_notyi: Array[HashMap[String, Double]]): (String, Double, Array[HashMap[String, Double]], Array[Double]) = {
    var bestCutPoint = ""
...
//        bestFaction = tempPro
  ...
  def splitNumeric(instances: ArrayBuffer[LabeledFeature],
    iAttr: Int,
    numClass: Int,
    Wi_notyi: Array[HashMap[String, Double]]): (Double, Double, Array[HashMap[String, Double]], Array[Double]) = {
