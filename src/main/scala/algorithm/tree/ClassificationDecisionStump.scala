...
object ClassificationDecisionStump {
  ...
  def splitNonimal(instances: ArrayBuffer[LabeledFeature],
    iAttr: Int): (String, Double, Array[HashMap[String, Double]], ArrayBuffer[LabeledFeature], ArrayBuffer[LabeledFeature], ArrayBuffer[LabeledFeature]) = {
    var bestCutPoint = ""
    ...
    (bestCutPoint, bestGini, bestDist, bestLeft, bestRight, bestMiss)
  }
...
//    parentGini
  ...
  def splitNumeric(index: Int, instances: ArrayBuffer[LabeledFeature],
    iAttr: Int): (Double, Double, Array[HashMap[String, Double]], ArrayBuffer[LabeledFeature], ArrayBuffer[LabeledFeature], ArrayBuffer[LabeledFeature]) = {
